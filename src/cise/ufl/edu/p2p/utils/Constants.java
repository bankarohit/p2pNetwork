...
public class Constants {
	...
	public static final String COMMON_PROPERTIES_CONFIG_PATH = System.getProperty("user.dir")
			+ File.separatorChar + "/resources/Common.cfg";
	...
	public static final String PEER_PROPERTIES_CONFIG_PATH = System.getProperty("user.dir")
			+ File.separatorChar + "/resources/PeerInfo.cfg";
}
